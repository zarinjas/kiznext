...
const shared = {
  typography: {
    ...
    h1: { fontFamily: font.heading, fontWeight: 600, fontSize: "1.5rem", lineHeight: 1.25, letterSpacing: "-0.025em" },
    h2: { fontFamily: font.heading, fontWeight: 600, fontSize: "1.25rem", lineHeight: 1.3, letterSpacing: "-0.02em" },
    h3: { fontFamily: font.heading, fontWeight: 600, fontSize: "1.0625rem", lineHeight: 1.4, letterSpacing: "-0.015em" },
    h4: { fontFamily: font.body, fontWeight: 600, fontSize: "0.9375rem", lineHeight: 1.45, letterSpacing: "-0.01em" },
    h5: { fontFamily: font.body, fontWeight: 600, fontSize: "0.875rem", lineHeight: 1.5, letterSpacing: "-0.01em" },
    h6: { fontFamily: font.body, fontWeight: 600, fontSize: "0.8125rem", lineHeight: 1.5 },
    body1: { fontSize: "0.875rem", lineHeight: 1.55, letterSpacing: "-0.006em" },
    body2: { fontSize: "0.8125rem", lineHeight: 1.55, letterSpacing: "-0.006em" },
    caption: { fontSize: "0.75rem", lineHeight: 1.4, fontWeight: 500, letterSpacing: "-0.006em" },
    overline: { fontSize: "0.6875rem", lineHeight: 1.4, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase" as const },
    button: { textTransform: "none" as const, fontWeight: 600, fontSize: "0.875rem", letterSpacing: "-0.006em" },
  ...
  colorSchemes: {
    light: {
      palette: {
        ...
        background: { default: "#FFFFFF", paper: color.surface },
