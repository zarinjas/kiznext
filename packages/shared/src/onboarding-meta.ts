/**
 * Onboarding meta — the curated gradient presets an admin can pick for each
 * welcome slide. Pure (no Prisma/Next/React) so the web admin and the mobile
 * app render the same backgrounds (web: CSS linear-gradient, mobile: SVG
 * LinearGradient from the same stop colours).
 */
