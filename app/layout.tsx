...
// "arrow_forward" flash on screen. The vendored file is a ~100 KB subset
// (FILL + wght axes only) regenerated by `npm run build:icons`; the full
// upstream font is ~5.3 MB and, on a phone, routinely outlived the block
// window so the raw names stuck. Re-run that script when adding a new icon.
