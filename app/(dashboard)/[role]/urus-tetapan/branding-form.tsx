...
/** Website branding — the logo shown on the login page, sidebar and favicon. */
export function BrandingForm({ currentLogoUrl }: Props) {
  ...
  return (
    <FormSection
      title="App Logo"
      subtitle="Shown on the login page, sidebar and the browser tab (favicon). PNG, JPEG, WebP, or SVG. Max 2MB."
      icon="image"
    >
