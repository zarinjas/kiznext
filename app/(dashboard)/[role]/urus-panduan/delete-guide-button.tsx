...
export function DeleteGuideButton({ id, name }: { id: string; name: string }) {
    ...
    <>
      ...
      >
        <Typography variant="body2" sx={{ color: "text.secondary", m: 0 }}>
          Remove <strong>{name}</strong> from the Digital Guide library? Residents will no longer see it. This can be undone later.
        </Typography>
      </KDialog>
    </>
  )
